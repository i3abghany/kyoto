...
class TestMatch : public ::testing::TestWithParam<utils::TestCase> {
protected:
...
INSTANTIATE_TEST_SUITE_P(TestMatch, TestMatch, testing::ValuesIn(generate_test_cases()));